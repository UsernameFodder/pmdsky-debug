...
enum swap_shop_shared_case {
    ...
    SWAP_SHARED_CASE_TALK_WHAT_INFO = 2,
    SWAP_SHARED_CASE_TALK_COME_AGAIN = 3,
    SWAP_SHARED_CASE_CLOSE_SHOP = 4,
    SWAP_SHARED_CASE_TALK_LACKING_SWAP_ITEMS = 5,
    ...
    SWAP_SHARED_CASE_INIT_SWAP_ITEMS_MENU = 11,
    SWAP_SHARED_CASE_SWAP_ITEMS_MENU = 12,
    SWAP_SHARED_CASE_RETURN_SWAP_ITEMS_MENU = 13,
    SWAP_SHARED_CASE_SELECT_SWAP_ITEM_OPTIONS = 14,
    SWAP_SHARED_CASE_SWAP_ITEM_GET_INFO = 15,
    SWAP_SHARED_CASE_TALK_CONFIRM_SWAP = 16,
    SWAP_SHARED_CASE_DO_SWAP_THEN_TALK = 17,
    SWAP_SHARED_CASE_INIT_SCRIPT_ACTION_1 = 18,
    SWAP_SHARED_CASE_INIT_SCRIPT_ACTION_2 = 19,
    SWAP_SHARED_CASE_INIT_SCRIPT_ACTION_3 = 20,
    SWAP_SHARED_CASE_TEXT_PUT_IN_CAULDRON = 21,
    SWAP_SHARED_CASE_TALK_WHAT_WOAH = 22,
    SWAP_SHARED_CASE_TALK_SUCCESSFUL_SWAP = 23,
    SWAP_SHARED_CASE_TEXT_RECEIVE_SWAP_ITEM = 24,
    SWAP_SHARED_CASE_TALK_SEND_TO_STORAGE = 25,
    SWAP_SHARED_CASE_CLOSE_DIALOGUE_BOX = 26,
    SWAP_SHARED_CASE_MAIN_MENU_OPTIONS = 27,
    SWAP_SHARED_CASE_SWAP_CANCELLED = 28,
    SWAP_SHARED_CASE_UNK_0x1D = 29,
    SWAP_SHARED_CASE_CONFIRM_CHOICE = 30,
    SWAP_SHARED_CASE_SWAP_DENIED = 31,
    SWAP_SHARED_CASE_TALK_SUBINFO_TRADE_2 = 32,
    SWAP_SHARED_CASE_SUBINFO_OPTIONS = 33,
    SWAP_SHARED_CASE_TALK_SUBINFO_TRADE_1 = 34,
    SWAP_SHARED_CASE_TALK_SUBINFO_LIST = 35,
    SWAP_SHARED_CASE_TALK_VIEW_WHOSE_LIST = 36,
    SWAP_SHARED_CASE_WHOSE_LIST_OPTIONS = 37,
    SWAP_SHARED_CASE_WHOSE_LIST_SUBOPTIONS = 38,
    SWAP_SHARED_CASE_CLOSE_LIST_SUBOPTIONS = 39,
    SWAP_SHARED_CASE_SHOW_SPECIES_SUMMARY = 40,
    SWAP_SHARED_CASE_CLOSE_SPECIES_SUMMARY = 41,
    SWAP_SHARED_CASE_SHOW_SPECIES_MOVES = 42,
    SWAP_SHARED_CASE_CLOSE_SPECIES_MOVES = 43,
    SWAP_SHARED_CASE_SHOW_SPECIES_MOVE_INFO = 44,
    SWAP_SHARED_CASE_RETURN_SPECIES_MOVES = 45,
    SWAP_SHARED_CASE_SHOW_SPECIES_IQ = 46,
    SWAP_SHARED_CASE_CLOSE_SPECIES_IQ = 47,
    SWAP_SHARED_CASE_TALK_LIST_SPECIES_CAN_USE = 48,
    SWAP_SHARED_CASE_INIT_SPECIES_LIST = 49,
    SWAP_SHARED_CASE_CLOSE_SPECIES_LIST = 50,
    SWAP_SHARED_CASE_SPECIES_LIST_ITEM_OPTIONS = 51,
    SWAP_SHARED_CASE_SPECIES_LIST_ITEM_INFO = 52,
    SWAP_SHARED_CASE_TALK_CANCEL_SPECIES_ITEM_LIST = 53,
    SWAP_SHARED_CASE_TALK_SEE_OTHER_LISTS = 54,
    SWAP_SHARED_CASE_SEE_OTHER_LIST_OPTIONS = 55,
    SWAP_SHARED_CASE_TALK_NOBODY_TO_TRADE_WITH = 56,
    SWAP_SHARED_CASE_TALK_WHICH_ITEMS_IN_RETURN = 57,
    SWAP_SHARED_CASE_INIT_TRADE_AWAY_LIST = 58,
    SWAP_SHARED_CASE_RESUME_TRADE_AWAY_LIST = 59,
    SWAP_SHARED_CASE_CLOSE_TRADE_AWAY_ITEM_LIST = 60,
    SWAP_SHARED_CASE_CLOSE_TRADE_AWAY_ITEM_LIST_INFO = 61,
    SWAP_SHARED_CASE_TRADE_AWAY_LIST_ITEM_OPTIONS = 62,
    SWAP_SHARED_CASE_SHOW_TRADE_AWAY_LIST_ITEM_INFO = 63,
    SWAP_SHARED_CASE_TALK_CANCEL_TRADE_AWAY_ITEM_LIST = 64,
    SWAP_SHARED_CASE_INIT_SWAP_SHOP = 65,
    SWAP_SHARED_CASE_UNK_0x42 = 66,
    SWAP_SHARED_CASE_UNK_0x43 = 67,
};
...
enum bar_update_case {
    BAR_INIT_AND_RETURN = 0,
    BAR_SUBCASE_FUNC = 1,
    BAR_GOTO_ESCAPE = 2,
    BAR_ESCAPE = 3,
    BAR_SUSPEND_NO_MSG = 4,
    BAR_DRINK_FOR_HERO = 5,
    BAR_DRINK_FOR_PARTNER = 6,
    BAR_DRINK_FOR_RECRUIT = 7,
    BAR_DRINK_END_RECRUIT = 8,
    BAR_DRINK_END_HERO = 9,
    BAR_DRINK_END_PARTNER = 10,
    BAR_MAKE_DRINK = 11,
    BAR_SELECT_MSG_SUSPEND = 12,
    BAR_MSG_PRE_SUSPEND = 13,
    BAR_SUSPEND_MSG = 14,
    BAR_MSG_POST_SUSPEND = 15,
    BAR_EGG_HERO_PARTNER = 16,
    BAR_EGG_RECRUIT = 17,
...
enum bar_subcase {
    SBAR_MAYBE_ESCAPE_SUB = -1,
    SBAR_INIT = 0,
    BAR_UNK_0x1 = 1,
    SBAR_MAIN_M_1ST_T = 2,
    SBAR_MAIN_M_AGAIN_T = 3,
    SBAR_MAIN_M_RESULTS = 4,
    SBAR_MAIN_M_INFO_W = 5,
    SBAR_MAIN_M_NO_ITEMS_W = 6,
    SBAR_ITEM_SEL_W = 7,
    SBAR_ITEM_SEL_M_INIT = 8,
    SBAR_ITEM_SEL_SUBM_INIT = 9,
    SBAR_ITEM_SEL_SUBM_RESULTS = 10,
    SBAR_ITEM_INFO_INIT = 11,
    SBAR_ITEM_INFO_CLOSE = 12,
    SBAR_TEAM_SEL_W = 13,
    SBAR_TEAM_SEL_M_INIT = 14,
    SBAR_TEAM_SEL_SUBM_INIT = 15,
    SBAR_TEAM_CONFIRM_M_INIT = 16,
    SBAR_TEAM_SUMMARY_INIT = 17,
    SBAR_TEAM_SUMMARY_CLOSE = 18,
    SBAR_TEAM_MOVES_M_INIT = 19,
    SBAR_TEAM_MOVES_M_RESULTS = 20,
    SBAR_TEAM_MOVE_INFO_INIT = 21,
    SBAR_TEAM_MOVE_INFO_CLOSE = 22,
    SBAR_TEAM_IQ_INIT = 23,
    SBAR_TEAM_IQ_CLOSE = 24,
    SBAR_TEAM_CONFIRM_M_RESULTS = 25,
    SBAR_TEAM_CONFIRM_M_CANCEL = 26,
    SBAR_CALL_MENTRY = 27,
    SBAR_ROLL_DRINK_DATA = 28,
    BAR_GOOD_SPINDA_REACT = 29,
    SBAR_MIRACLE_SPINDA_REACT = 30,
    SBAR_MIRACLE_1ST_TASTE = 31,
    SBAR_MIRACLE_REACT_1 = 32,
    SBAR_MIRACLE_REACT_2 = 33,
    SBAR_OTHER_1ST_TASTE = 34,
    SBAR_OTHER_REACT_1 = 35,
    SBAR_BAD_DRINK_RARE_RESUME = 36,
    SBAR_CALC_STAT_CHANGES = 37,
    SBAR_DO_POSITIVE_DRINK_EVENT = 38,
    SBAR_MIRACLE_DRINK_RESUME = 39,
    SBAR_DO_NEGATIVE_DRINK_EVENT = 40,
    SBAR_HANDLE_LEVEL_UP = 41,
    SBAR_EGG_TURN_SUSPEND = 42,
    SBAR_EGG_TURN_RESUME = 43,
    SBAR_EGG_UNTURN_SUSPEND = 44,
    SBAR_EGG_UNTURN_RESUME = 45,
    SBAR_EGG_FINISH = 46,
    SBAR_GOURMET_FIRST_LINE = 47,
    SBAR_GOURMET_SUSPEND = 48,
    SBAR_GOURMET_DISP_PORTRAIT = 49,
    SBAR_GOURMET_ASK_JOIN = 50,
    SBAR_GOURMET_CHECK_CHOICE = 51,
    SBAR_GOURMET_REJECT_DELAY = 52,
    SBAR_GOURMET_REJECT_END = 53,
    SBAR_GOURMET_ACCEPT_DELAY = 54,
    SBAR_GOURMET_ACCEPT_SUSPEND = 55,
    SBAR_GOURMET_FINISH = 56,
    SBAR_EMPTY_0x39 = 57,
    SBAR_DUNGEON_FIRST_LINE = 58,
    SBAR_DUNGEON_DISPLAY_MAP = 59,
    SBAR_DUNGEON_FINISH = 60,
...
enum daycare_menu_state { // Used to manage switch-cases in Chansey Daycare
    DAYCARE_INIT = 0,
    DAYCARE_MAYBE_TAKEEGG = 1,
    DAYCARE_INFO = 2,
    DAYCARE_CHECKON = 3,
    DAYCARE_STATE_UNK_0x4 = 4,
    DAYCARE_EGGHATCH = 5,
    DAYCARE_SEEMINGLYIDENTICAL_EGGHATCH2 = 6,
    DAYCARE_SEEMINGLYIDENTICAL_EGGHATCH3 = 7,
    DAYCARE_EGGHATCH_NEVERMIND = 8,
    DAYCARE_EGGHATCH_INIT = 9,
    DAYCARE_RECRUIT_BABY = 10,
    DAYCARE_STATE_UNK_0xb = 11,
    DAYCARE_STATE_UNK_0xc = 12,
    DAYCARE_STATE_UNK_0xd = 13,
    DAYCARE_RECRUIT_CHOICER = 14,
    DAYCARE_SOMETHING_SETUPBABY = 15,
    DAYCARE_MAYBE_GIVEEGGSTATBONUS = 16,
    DAYCARE_STATE_UNK_0x11 = 17,
    DAYCARE_STATE_UNK_0x12 = 18,
    DAYCARE_STATE_UNK_0x13 = 19,
    DAYCARE_STATE_UNK_0x14 = 20,
    DAYCARE_STATE_UNK_0x15 = 21,
    DAYCARE_STATE_UNK_0x16 = 22,
    DAYCARE_STATE_UNK_0x17 = 23,
    DAYCARE_STATE_UNK_0x18 = 24,
    DAYCARE_STATE_UNK_0x19 = 25,
    DAYCARE_MAYBE_MAINMENU = 26,
    DAYCARE_STATE_UNK_0x1b = 27,
    DAYCARE_STATE_UNK_0x1c = 28,
    DAYCARE_STATE_UNK_0x1d = 29,
    DAYCARE_STATE_UNK_0x1e = 30,
    DAYCARE_RECRUIT = 31,
    DAYCARE_UNK_KEYBOARDRELATED_0x20 = 32,
    DAYCARE_UNK_KEYBOARDRELATED_0x21 = 33,
    DAYCARE_STATE_UNK_0x22 = 34,
    DAYCARE_STATE_UNK_0x23 = 35,
    DAYCARE_STATE_UNK_0x24 = 36,
    DAYCARE_STATE_UNK_0x25 = 37,
    DAYCARE_STATE_UNK_0x26 = 38
};
