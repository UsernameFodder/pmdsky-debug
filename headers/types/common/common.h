...
struct audio_command {
    // 0x0: Seems to be a value that marks the status of this entry. It's probably an enum, maybe a command ID. Seems
    // to be 0 when the entry is not in use.
    int status;
    struct music_id_16; // 0x4: ID of the music to play
