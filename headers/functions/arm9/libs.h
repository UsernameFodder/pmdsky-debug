...
void OS_InitContext(struct thread* thread, void* function, void* stack_area_minus_4);
...
void OS_GetDtcmAddress(void);
void OS_EnableProtectionUnit(void);
void OS_DisableProtectionUnit(void);
void OS_SetDPermissionsForProtectionRegion(void);
...
void OSi_DisplayExContent(void);
void OSi_SetTimerReserved(void);
void OS_InitTick(void);
void OS_IsTickAvailable(void);
void OSi_CountUpTick(void);
void OS_GetTick(void);
uint16_t OS_GetTickLo(void);
void OS_SetTick(void);
void OSi_SetTimer(void);
void OS_InitAlarm(void);
void OS_IsAlarmAvailable(void);
void OS_CreateAlarm(void);
void OS_InsertAlarm(void);
void OS_SetAlarm(void);
void OSi_AlarmHandler(void);
void OSi_ArrangeTimer(void);
void OS_InitVAlarm(void);
int OS_EnableInterrupts(void);
int OS_DisableInterrupts(void);
int OS_RestoreInterrupts(int new_value);
int OS_EnableInterrupts_IrqAndFiq(void);
int OS_RestoreInterrupts_IrqAndFiq(int new_value);
int OS_GetCpsrIrq(void);
int OS_GetProcMode(void);
void OS_InitReset(void);
void OSi_CommonCallback(void);
void OSi_SendToPxi(void);
...
void MTi_CardDmaCopy32(void);
void MI_Init(void);
void PushCommand_Impl(void);
void Snd_Init(void);
