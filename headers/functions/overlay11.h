...
undefined4 EatOverworldGummiEntryPoint(void);
void EatOverworldGummiDestructor(void);
undefined4 EatOverworldGummiFrameUpdate(void);
int CreateTopGroundMenu(void);
void CloseTopGroundMenu(void);
int UpdateTopGroundMenu(void);
undefined4 GroundBagOthersMenuEntryPoint(void);
void GroundBagOthersMenuDestructor(void);
undefined4 GroundBagOthersMenuFrameUpdate(void);
undefined4 DiaryMenuDiaryMenuEntryPoint(undefined4 param_1);
void DiaryMenuDestructor(void);
undefined4 DiaryMenuFrameUpdate(void);
void InitDiaryandFaqBoardMenu(undefined4 param_1);
