...
void GenerateMonsterSummaryOuter(damage_source_16 param_1,struct entity *param_2,struct monster *param_3,int param_4);
...
void GonePebbleGradualPaletteShift(struct rgba *param_1,uint param_2);
