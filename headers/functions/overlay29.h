...
struct trap* GetTrapData(struct entity* trap_entity);
struct item* GetItemData(struct entity* item_entity);
...
void InitMinimapDisplayTile(struct minimap_display_tile* minimap_display_tile, void* ptr);
