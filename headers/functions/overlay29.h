...
struct item* GetUsedItem(struct entity* entity, union item_index item_index);
...
uint8_t GetOffensiveStatAtLevel(enum monster_id monster_id, int level, int stat_type);
uint8_t GetDefensiveStatAtLevel(enum monster_id monster_id, int level, int stat_type);
