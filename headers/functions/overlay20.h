...
void PrintWynautNormalPortrait(struct recycle_shop_main* recycle_shop_main);
void RecycleShopClosePortraitBox(struct recycle_shop_main* recycle_shop_main);
...
void RecycleShopTopScreenDrawInfoWindow(int window_id, undefined4 param_2, undefined4 param_3,
                                        undefined4 param_4);
void DisplaySelectionTutorialWindow(int window_id, undefined4 param_2, undefined4 param_3,
                                    undefined4 param_4);
