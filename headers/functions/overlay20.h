...
void PrintWynautSimpleMenu(struct recycle_shop_main* param_1, undefined4 string_id,
                           struct simple_menu_id_item* param_3);
...
void RecycleShopTopScreenDrawInfoWindow(int param_1, undefined4 param_2, undefined4 param_3,
                                        undefined4 param_4);
