...
void ApplyGummiBoostsGround(undefined2* param_1, undefined2* param_2, undefined* param_3,
                            undefined* param_4, undefined2 param_5, void* buffer);
...
uint8_t GetMaxRescueAttempts(enum dungeon_id dungeon_id);
