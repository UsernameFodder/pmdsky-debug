...
uint32_t GetNbPkmnBattled(void);
...
void RecruitSpecialPokémonLog(enum monster_id monster_id);
...
uint32_t GetFootprintsGamePoints(int32_t rank);
int32_t SetFootprintsGamePoints(uint32_t points);
