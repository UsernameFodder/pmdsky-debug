...
int MultiplyByFixedPoint(int x, fx32_8 mult);
uint32_t UMultiplyByFixedPoint(uint32_t x, ufx32_8 mult);
void IntToFixedPoint64(struct fx64_16* out, int x);
int FixedPoint64ToInt(struct fx64_16* x);
void FixedPoint32To64(struct fx64_16* out, fx32_8 x);
...
uint32_t BinToDecFixedPoint(fx32_16* q16);
