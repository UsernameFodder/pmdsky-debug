...
void DigitInputMenuInit(struct digit_input_window_manager *digit_input_manager);
int32_t DigitInputMenuReturn(struct digit_input_window_manager *digit_input_manager);
void DigitInputMenuInitDigits(struct digit_input_window_manager *digit_input_manager);
undefined DigitInputMenuGetDigits(int *digit_values,int max_value,int max_digit);
undefined4 DigitInputMenuFrameUpdate(struct digit_input_window_manager *digit_input_manager);
undefined4 DigitInputMenuCheckValidTouchScreenInput(struct digit_input_window_manager *digit_input_manager);
undefined DigitInputMenuCheckTouchUpDownArrow(struct digit_input_window_manager *digit_input_manager,int param_2,int param_3);
void DigitInputMenuDrawDigits(struct digit_input_window_manager *digit_input_manager);
