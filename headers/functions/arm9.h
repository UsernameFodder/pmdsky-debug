...
void CopyProgressInfoToBitstream(struct bitstream* stream, undefined4 param_2, undefined4 param_3, int param_4);
uint32_t GetProgressInfoForSave(void* dst, uint32_t len);
void CopyProgressInfoFromBitstream(struct bitstream* stream);
undefined4 ReadProgressInfoFromSave(void* src, uint32_t len);
